            ...
            <AnimatePresence initial={false} custom={direction}>
              ...
              >
                <ImageMagnifier
                  ...
                  show={showMagnifier}
                  onload={() => { setLoaded(true); setShowMagnifier(true) }}
                />
              </motion.div>
            </AnimatePresence>
          </div>
        ...
        <div className="absolute inset-0 mx-auto flex max-w-7xl items-center justify-center">
          ...
          {loaded && (
            <div className="relative aspect-[3/2] max-h-full w-full">
              ...
              <div className="absolute z-50 right-0 top-0 flex items-center gap-2 p-3 text-white">
                {navigation ? (
                  <a
              ...
              <div className="absolute z-50 left-0 top-0 flex items-center gap-2 p-3 text-white">
                <button
                  onClick={() => closeModal()}
                  className="rounded-full bg-black/50 p-2 text-white/75 backdrop-blur-lg transition hover:bg-black/75 hover:text-white"
                >
